...
1. You need CMake 3.10 or newer to build liblscp

2. Unpack the liblscp sources somewhere, or checkout the repository, 
   and create a build directory. For instance, using a command line shell:
   
$ tar -xvzf Downloads/liblscp-x.y.z.tar.gz
$ cd liblscp-x.y.z
$ mkdir build
...
The CMake build system for liblscp is experimental. It will take a while
